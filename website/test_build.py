...
class WebsiteTest(unittest.TestCase):
    def test_readme_resources_survive_build(self):
        ...
        for ident, count in [('articles', 7), ('papers', 52), ('datasets', 4), ('benchmarks-1', 20)]:
        ...
        self.assertEqual(len(page.select('#projects .demo-card')), 48)
        ...
        self.assertEqual(len(page.select('#papers .reading-entry')), 52)
        ...
        self.assertEqual(len(page.select('.entry[data-demo]')), 48)
