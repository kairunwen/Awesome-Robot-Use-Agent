...
Selected X / Twitter posts about GPT-6 Astra, with dates in UTC+8. Updated through 2026-09-13: 33 demo/evaluation posts are grouped into 32 entries. Related articles are listed under Articles. Results below are author-reported unless stated otherwise.
...
| <a href="https://github.com/cheng-haha/GPT-Policy-Eval"><img src="https://raw.githubusercontent.com/cheng-haha/GPT-Policy-Eval/main/assets/plug-insertion-keyframe.png" alt="GPT-Policy-Eval — real-robot plug insertion with top and wrist camera views" width="200"></a><br>[▶ Video](https://github.com/cheng-haha/GPT-Policy-Eval/raw/refs/heads/main/assets/plug-insertion-top-and-right-wrist.mp4) | **GPT-Policy-Eval** | 2026-09-11 | Real · robot manipulation | Uses GPT-6 Astra with a video demonstration or reference images and live visual feedback for plug insertion, revealing a hidden goal, and arranging blocks. <details class="entry-notes"><summary>Sources & notes</summary>[Repository and demos](https://github.com/cheng-haha/GPT-Policy-Eval) · [Post](https://x.com/z_code68632/status/2098401554676269236). Research preview with selected individual trials, accelerated 8–24×; the plug-insertion clip is 12×. Code release and systematic evaluation are planned, not yet provided. No aggregate success rate is reported.</details> |
