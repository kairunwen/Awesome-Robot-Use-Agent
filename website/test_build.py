...
class WebsiteTest(unittest.TestCase):
    def test_readme_resources_survive_build(self):
        ...
        for ident, count in [('articles', 2), ('papers', 16), ('benchmarks-1', 4)]:
        ...
        self.assertEqual([len(d.select('.entry')) for d in disclosures], [14, 4, 3, 10, 11])
        ...
        self.assertEqual(len(page.select('#projects .preview-entry img')), 11)
