...
class WebsiteTest(unittest.TestCase):
    def test_readme_resources_survive_build(self):
        ...
        self.assertEqual([h.get_text() for h in page.select('#papers h3')], ['Surveys', 'Methods & Frameworks', 'Datasets', 'Benchmarks'])
        self.assertIsNotNone(page.select_one('#papers h3#benchmarks'))
        self.assertIsNotNone(page.select_one('section#benchmarks-1'))
        for ident, count in [('articles', 6), ('papers', 54), ('benchmarks-1', 18)]:
        ...
        self.assertEqual(len(page.select('#papers .reading-entry')), 54)
